...
| Aula | Evolução do laboratório | Branch |
|---|---|---|
| 2.1 — O que existe por trás de um chat | Exposição e visualização do payload de mensagens | `lesson/m02-a01-payload-conversacao` |
| 2.3 — Persona não é fantasia | Definição de identidade, escopo e comportamento do assistente | `lesson/m02-a03-persona-assistente` |
| 2.5 — Resumo de conversa | Compactação e resumo incremental do histórico | `lesson/m02-a05-resumo-conversa` |
...
| Aula | Evolução do laboratório | Branch |
|---|---|---|
| 3.3 — SDD na prática com `tlc-spec-driven` | Instalação da skill e criação da Spec da evolução generativa | `lesson/m03-a03-sdd-tlc-spec-driven` |
