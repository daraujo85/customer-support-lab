...
| 3.9 — Prompts como artefatos versionados | Extração dos prompts do código e versionamento | `lesson/m03-a09-prompts-versionados` ✅ criada |
| 3.10 — Montagem condicional de prompts | Condições determinísticas resolvidas antes da inferência | `lesson/m03-a10-prompts-condicionais` ✅ criada |
